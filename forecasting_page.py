...
def render_forecasting_page() -> None:
    ...
    with h_label_col:
     st.markdown(
        '<p style="color:#D5D7F8;font-size:24px;margin-right:0;padding-right:0;text-align:left;">choose horizon :</p>',
        unsafe_allow_html=True,
    )
    ...
    with right:
        # Menambahkan div dengan kelas CSS .bottom-card untuk styling
        st.markdown(
            """
            <div class="bottom-card">
        ...
        # Memformat dataframe ke dalam HTML
