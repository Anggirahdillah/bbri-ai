...
def render_forecasting_page() -> None:
    ...
    if "forecast_horizon_radio" not in st.session_state:
        st.session_state["forecast_horizon_radio"] = "7D"
    ...
    with top_left:
        ...
        with h_radio_col:
            ...
            # sinkronkan radio dengan horizon di state
            current_label = label_map.get(current_horizon, "7D")
            st.session_state["forecast_horizon_radio"] = current_label
