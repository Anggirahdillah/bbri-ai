...
def render_dashboard(data_dict):
    ...
    st.markdown(
        ...
        <div class="big-card">
            ...
            <p style="font-size:26px; color:#C9D1D9; line-height:1.4; margin:10px;">
    ...
    with col_left:
        st.markdown(
            ...
            <div class="metric-card">
                ...
                <ul style="font-size:26px; color:#C9D1D9; line-height:1.5; margin:0; padding-left:18px;">
    ...
    # KANAN: TECHNOLOGY USED + TEAM MEMBERS (BERTUMPUK)
    with col_right:
        # TECHNOLOGY USED
        st.markdown(
            """
